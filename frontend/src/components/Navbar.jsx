...
export default function Navbar() {
  ...
  return <div className=' flex justify-between py-8 px-8 md:px-20 items-center h-24 container mx-auto'>
    ...
    <div className={!nav ? 'md:hidden pt-10 fixed left-0 top-0 w-full z-50 border-r border-r-gray-900 h-full bg-gray-300 translation ease-in-out duration-500' : 'md:hidden pt-10 z-50  fixed -left-full  translation  ease-in-out duration-500'} >
