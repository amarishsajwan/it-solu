        ...
        <div className="flex flex-col md:flex-row">
          <div className=" flex flex-col divide-y-4 divide-gray-c md:mr-8">
            ...
            <div className="flex flex-col lg:flex-row lg:px-8 py-8 justify-between  ">
              ...
              <div className="w-full lg:w-3/4">
                <h5 className=" mt-2 mb-6 text-xl  font-semibold">Dedicated team</h5>
                <p>
            ...
            <div className="flex flex-col lg:flex-row lg:px-8 py-8 justify-between  ">
              ...
              <div className="w-full lg:w-3/4">
                <h5 className=" mt-2 mb-6 text-xl  font-semibold">QA And Testing</h5>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit
                  ad, veniam deserunt illum quam maxime ea, voluptates
                  perferendis cum architecto iure.
            ...
            <div className="flex flex-col lg:flex-row lg:px-8 py-8 justify-between  ">
              ...
              <div className="w-full lg:w-3/4">
                <h5 className=" mt-2 mb-6 text-xl  font-semibold">SaaS</h5>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit
                  ad, veniam deserunt illum quam maxime ea, voluptates
                  perferendis cum architecto iure.
          ...
          <div className=" flex flex-col divide-y-4 divide-gray-c md:mr-8">
            ...
            <div className="flex flex-col lg:flex-row lg:px-8 py-8 justify-between  ">
              ...
              <div className="w-full lg:w-3/4">
                <h5 className=" mt-2 mb-6 text-xl  font-semibold">Blockchain</h5>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit
                  ad, veniam deserunt illum quam maxime ea, voluptates
                  perferendis cum architecto iure.
            ...
            <div className="flex flex-col lg:flex-row lg:px-8 py-8 justify-between  ">
              ...
              <div className="w-full lg:w-3/4">
                <h5 className=" mt-2 mb-6 text-xl  font-semibold">Artificial Intelligence</h5>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit
                  ad, veniam deserunt illum quam maxime ea, voluptates
                  perferendis cum architecto iure.
            ...
            <div className="flex flex-col lg:flex-row lg:px-8 py-8 justify-between  ">
              ...
              <div className="w-full lg:w-3/4">
                <h5 className=" mt-2 mb-6 text-xl  font-semibold">Internet of Things</h5>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit
                  ad, veniam deserunt illum quam maxime ea, voluptates
                  perferendis cum architecto iure.
